...
if equipos_count == 0:
    print("❌ No hay equipos. Ejecuta primero 'alimentar_ares.py' para cargar los clubes.")
    exit()
...
print("📡 Descargando partidos desde API-Football...")
...
for p in partidos:
    ...
    # Insertar predicción (datos simulados, puedes mejorarlos después)
    cur.execute("""
...
conn.commit()
print(f"\n🎉 {insertados} partidos de la Bundesliga guardados con sus predicciones.")
