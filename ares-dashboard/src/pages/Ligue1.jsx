...
function Ligue1() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8000/api/ligas/ligue1')
    ...
    return (
        <div className="p-6">
            <h1 className="text-3xl font-bold mb-6">🇫🇷 Ligue 1 - Predicciones ARES</h1>
...
export default Ligue1  // <--- ESTA LÍNEA ES CRUCIAL